...
subject1 <- data.frame(fromJSON("data/subject1.json"))
subject2 <- data.frame(fromJSON("data/subject2.json"))
subject3 <- data.frame(fromJSON("data/subject3.json"))
# combine data
